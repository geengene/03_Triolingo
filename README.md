...
[![Build Status](https://gitlab.com/JASchilz/Duolingo/badges/master/pipeline.svg)](https://gitlab.com/JASchilz/Duolingo/badges/master/pipeline.svg)
...
`abbreviations` (boolean) _optional_  
...
`language_abbr` (string) _optional_  
